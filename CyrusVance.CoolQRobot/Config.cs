namespace CyrusVance.CoolQRobot {
    ...
    public class Config {
        ...
        public static Enums.Verbosity internal_logger_verbosity {
            get {
                return Utils.Logger.GetLogger ("CyrusVance.CoolQRobot").log_level;
            }
            set {
                Utils.Logger.GetLogger ("CyrusVance.CoolQRobot").log_level = value;
            }
        }
        /// <summary>默认日志输出位置</summary>
        public static Enums.LogType internal_logger_output {
            get {
                return Utils.Logger.GetLogger ("CyrusVance.CoolQRobot").log_type;
            }
            set {
                Utils.Logger.GetLogger ("CyrusVance.CoolQRobot").log_type = value;
            }
        }
    }
}