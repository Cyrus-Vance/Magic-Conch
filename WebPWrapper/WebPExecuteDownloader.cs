...
namespace WebPWrapper {
    ...
    public static class WebPExecuteDownloader {
        ...
        /// Windows环境下的URL
        /// </summary>
        public const string _windowsUrl = "https://ipdle.com/cyrustools/qqrobot/webplib/libwebp-1.0.2-windows-x86.zip";
        
        /// <summary>
        /// Linux环境下的URL
        /// </summary>
        public const string _linuxUrl = "https://ipdle.com/cyrustools/qqrobot/webplib/libwebp-1.0.2-linux-x86-64.tar.gz";
        ...
        /// 下载目标文件库
        /// </summary>
        /// <param name="ignoreIfExtsis"></param>
        /// <returns></returns>
