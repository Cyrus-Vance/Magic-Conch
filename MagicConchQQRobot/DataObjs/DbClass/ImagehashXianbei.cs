...
namespace MagicConchQQRobot.DataObjs.DbClass
{
    ...
    [BindTable("ImageHash_Xianbei", Description = "", ConnName = "CvqRobotDB", DbType = DatabaseType.None)]
    public partial class ImagehashXianbei
    {
        #region 属性
        ...
        #region 字段名
        /// <summary>取得ImagehashXianbei字段信息的快捷方式</summary>
        ...
        /// <summary>取得ImagehashXianbei字段名称的快捷方式</summary>
