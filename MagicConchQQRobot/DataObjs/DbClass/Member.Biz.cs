...
namespace MagicConchQQRobot.DataObjs.DbClass
{
    ...
    public partial class Member : Entity<Member>
    {
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            if (Code.IsNullOrEmpty()) throw new ArgumentNullException(nameof(Code), "Code不能为空！");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化Member[Member]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化Member[Member]数据！");
        //}
